...
public class MediationAdBanner {
    ...
    public static void showFacebookBanner(boolean isPurchased, Activity activity, ViewGroup bannerContainer, String facebookKey, OnBannerAdListener onBannerAdListener) {
        showBanner(isPurchased, activity, bannerContainer, facebookKey, null, new Integer[]{MediationAdHelper.AD_FACEBOOK}, onBannerAdListener);
    }

    public static void showAdmobBanner(boolean isPurchased, Activity activity, ViewGroup bannerContainer, String admobKey, OnBannerAdListener onBannerAdListener) {
        showBanner(isPurchased, activity, bannerContainer, null, admobKey, new Integer[]{MediationAdHelper.AD_ADMOB}, onBannerAdListener);
    }
    ...
    public static void showBanner(boolean isPurchased, Activity activity, ViewGroup bannerContainer, String facebookKey, String admobKey, Integer[] tempAdPriorityList, OnBannerAdListener onBannerAdListener) {
        if (isPurchased)
            return;
    ...
    private static boolean isPkgInstalledAlready() {
        ...
        if (IUtils.isContainPkg(cubiBannerAd.getBannerAdUrlLink())) {
            ...
            {Log.d("TAG1_nativeBanner", "isPkgInstalledAlready: true ");return false;}
        } else
            return false;

...
public class AdTimeLimits {
    static String BANNER_KEY="BANNER_KEYS";
    static String INTERSTITIAL_KEY="INTERSTITIAL_KEY";
    static String NATIVE_BANNER_KEY="NATIVE_BANNER_KEY";
    static String NATIVE_KEY="NATIVE_KEY";
    boolean can_skip;
    long banner_ad_time;

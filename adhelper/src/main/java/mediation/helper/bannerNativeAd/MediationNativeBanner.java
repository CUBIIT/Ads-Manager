...
//    }
    ...
    public MediationNativeBanner(ViewGroup itemView, Context context, String app_name, String facebook_ad_key, String admob_ad_key, MediationAdHelper.ImageProvider imageProvider) {
    ...
    public MediationNativeBanner(ViewGroup itemView, Context context, String app_name, String facebook_ad_key, String admob_ad_key, CubiBannerAd cubiBannerAd, MediationAdHelper.ImageProvider imageProvider) {
        this.containerView = itemView;
        this.context = context;
        this.app_name = app_name;
        this.facebook_ad_key = facebook_ad_key;
